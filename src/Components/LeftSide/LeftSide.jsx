...
function LeftSide() {
  ...
  return (
    <aside className="w-full md:w-80 p-6 rounded-xl shadow-md bg-[#111111] dark:bg-[#543314] transition-colors duration-300">
      {/* Photo and Name */}
      <div className="flex flex-row md:flex-col items-start md:items-center text-center">
        <div className="relative w-28 h-28 md:w-40 md:h-40 rounded-full overflow-hidden mb-4 md:mb-6">
          <img
            src="/assets/myphoto.png"
            alt="my-photo"
        ...
        <div className="flex flex-col ml-4 md:ml-0 items-center md:items-center">
          <span
            ref={typedRef}
            className="text-2xl font-bold min-h-[36px] bg-gradient-to-r from-[#FFD700] via-[#FFB700] to-[#FF8C00] text-transparent bg-clip-text"
          ></span>

          <p className="bg-[#333333] dark:bg-[#3a1f13] px-3 py-1 text-sm rounded-full font-semibold mt-1 text-[#f5f5f5] dark:text-[#f5f5f5]">
            Software Engineer
          </p>
        </div>
      </div>
      ...
      {/* Email & Address */}
      <div className="flex flex-col items-start space-y-4 mt-8 text-sm text-[#D1D1D1] dark:text-[#D1D1D1]">
        <div className="flex items-center gap-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5 text-[#FFD700] dark:text-[#FFB700]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div className="flex justify-center items-center space-x-4 mt-6">
        {[{
          ...
          },
          {
            ...
            icon: (
              <svg
                ...
                stroke="currentColor"
              >
                <path d="M15 22v-4a4.8 4.8 0 00-1-3.5c3 0 6-2 6-5.5.1-1.25-.3-2.5-1-3.5.3-1.15.3-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.4 5.4 0 004 9c0 3.5 3 5.5 6 5.5-.4.5-.7 1-.9 1.7-.2.6-.2 1.2-.2 1.8v4" />
          ...
          <a
            ...
            href={href}
            target="_blank"
            className="w-[40px] h-[40px] bg-[#1a1a1a] dark:bg-[#333333] flex justify-center items-center rounded-xl text-white hover:text-[#FFD700] dark:hover:text-[#FFB700] transition-colors"
          >
            {icon}
          </a>
        ))}
